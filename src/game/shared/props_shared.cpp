...
int CPropData::ParsePropFromKV( CBaseEntity *pProp, KeyValues *pSection, KeyValues *pInteractionSection )
{
	...
	pBreakableInterface->SetDmgModFire( pSection->GetFloat( "dmg.fire", pBreakableInterface->GetDmgModFire() ) );
...
const char *GetMassEquivalent(float flMass)
{
	...
	} masstext[] =
	{
		...
		{ 0.05,		"golf ball" },
		{ 0.17,		"billard ball" },
		{ 2,		"small bag of methé" },
		{ 7,		"male pussycat" },
		{ 10,		"bowling ball" },
		{ 30,		"dog" },
		{ 60,		"cheetah" },
		{ 90,		"Fred Flintstone" },
		{ 250,		"stocked refrigerator" },
		{ 600,		"race horse" },
		{ 1000,		"volkswagon beetle" },
		{ 1650,		"your moms car" },
		{ 2500,		"empty humvee" },
		{ 6000,		"t-rex" },
		{ 7200,		"elephant" },
		{ 8e4,		"space shuttle" },
		{ 7e5,		"sixty-nine car locomotive" },
		{ 9.2e6,	"Eiffel tower" },
		{ 6e24,		"the Earth" },
		{ 7e24,		"Black-hole of doom" },
	};
