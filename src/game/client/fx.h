...
void FX_BigTracer( Vector& start, Vector& end, int velocity, bool makeWhiz = true, unsigned char *pTracerColor = NULL );
...
void FX_RicochetSpark( const Vector &position, const Vector &direction, const Vector &surfaceNormal, int iScale = 1 );
