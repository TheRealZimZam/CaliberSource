...
//
// TODO; Draw the hammer sprites in-game with a command
//=============================================================================
...
//=============================================================================
// OBSOLETE ENTITIES
// For HL1/OldSource Compatibility
//=============================================================================
...
bool CAutoTrigger::KeyValue( const char *szKeyName, const char *szValue )
{
...
//
// Trigger relay - sends a specific trigger state to its target
//
//
...
private:
	bool IsClone( void ) { return HasSpawnFlags( SF_MULTIMAN_CLONE ) ? TRUE : FALSE; }
