...
//
// Purpose: Simple CTF Flag.
//
// TODO; Code this thing!
// CTF Flag - is spawned in by gamerules, and is owned by the whole team. 
// Can be set to only be picked up on use, and the model can be changed
// by info_flag_position.
//=============================================================================//
#include "cbase.h"
...
// Flag position for editor
LINK_ENTITY_TO_CLASS( info_flag_position, CPointEntity );
...
#define DEFAULT_FLAG_MODEL				"models/flag/flag.mdl"
...
LINK_ENTITY_TO_CLASS( item_flag, CCaptureFlag );
