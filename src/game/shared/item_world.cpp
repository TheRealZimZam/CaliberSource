...
IMPLEMENT_NETWORKCLASS_ALIASED( Item, DT_Item )

BEGIN_NETWORK_TABLE( CItem, DT_Item )
END_NETWORK_TABLE()
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CItem::ShouldDraw()
{
	// If I'm carrying this thing, don't draw it
...
//-----------------------------------------------------------------------------
ShadowType_t CItem::ShadowCastType()
{
...
{
	// Create the object in the physics system if possible
