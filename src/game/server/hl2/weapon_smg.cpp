...
IMPLEMENT_SERVERCLASS_ST( CHLGrenadeLauncher, DT_HLGrenadeLauncher )
END_SEND_TABLE()

//=========================================================
//	>> CHLGrenadeLauncher
//=========================================================
BEGIN_DATADESC( CHLGrenadeLauncher )
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CHLGrenadeLauncher::GetPrimaryAttackActivity( void )
{
	if ( m_nShotsFired < 2 )
...
// SMG1
//-----------------------------------------------------------------------------
class CWeaponSMG1 : public CHLGrenadeLauncher
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS( CWeaponSMG1, CHLGrenadeLauncher );
...
void CWeaponSMG2::AddViewKick( void )
{
	...
	DoMachineGunKick( pPlayer, SMG_EASY_DAMPEN, SMG2_MAX_VERTICAL_KICK, m_fFireDuration, SMG2_SLIDE_LIMIT );
}
