...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY( ACT_LADDER_UP );
	REGISTER_SHARED_ACTIVITY( ACT_LADDER_DOWN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_SIGNAL_BACK );
	...
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_SIGNAL_BACK );
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_PRONE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SCARED );
	...
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_USE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_USE );
	REGISTER_SHARED_ACTIVITY( ACT_VM_FIDGET );
	REGISTER_SHARED_ACTIVITY( ACT_VM_JAM );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_VM_ATTACH );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_DETACH );
...
//	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_SMG2_LOW );
	...
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_SUPERSHOTGUN );
...
//!	REGISTER_SHARED_ACTIVITY( ACT_RANGE_AIM_HMG_LOW );
	...
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_RANGE_ATTACK_SUPERSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_RANGE_ATTACK_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_MELEE_ATTACK_SWING );
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_MELEE_ATTACK_STAB );
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_ANGRY_FLAMETHROWER );
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_MANNEDGUN_LARGE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_WALK_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_FLAMETHROWER );
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY( ACT_SHOTGUN_IDLE2 );
	REGISTER_SHARED_ACTIVITY( ACT_SHOTGUN_IDLE3 );
