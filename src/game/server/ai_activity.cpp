...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR( ACT_LADDER_UP );
	ADD_ACTIVITY_TO_SR( ACT_LADDER_DOWN );
	...
	ADD_ACTIVITY_TO_SR( ACT_SIGNAL_BACK );
	...
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_SIGNAL_BACK );
	...
	ADD_ACTIVITY_TO_SR( ACT_IDLE_PRONE );
	...
	ADD_ACTIVITY_TO_SR( ACT_IDLE_SCARED );
	...
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_USE );
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_USE );
	ADD_ACTIVITY_TO_SR( ACT_VM_FIDGET );
	ADD_ACTIVITY_TO_SR( ACT_VM_JAM );
	...
	// Can also be used for other attachments if needed
	ADD_ACTIVITY_TO_SR( ACT_VM_ATTACH );
	ADD_ACTIVITY_TO_SR( ACT_VM_DETACH );
...
//	ADD_ACTIVITY_TO_SR( ACT_RANGE_ATTACK_SMG2_LOW );	//SMG1_LOW works fine
	ADD_ACTIVITY_TO_SR( ACT_RANGE_ATTACK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RANGE_ATTACK_SHOTGUN_LOW );
	ADD_ACTIVITY_TO_SR( ACT_RANGE_ATTACK_SUPERSHOTGUN );
...
//!	ADD_ACTIVITY_TO_SR( ACT_RANGE_AIM_HMG_LOW );
	...
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_RANGE_ATTACK_SUPERSHOTGUN );
	...
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_RANGE_ATTACK_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_MELEE_ATTACK_SWING );
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_MELEE_ATTACK_STAB );
	...
	ADD_ACTIVITY_TO_SR( ACT_IDLE_ANGRY_FLAMETHROWER );
	...
	ADD_ACTIVITY_TO_SR( ACT_IDLE_MANNEDGUN_LARGE );
	...
	ADD_ACTIVITY_TO_SR( ACT_WALK_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_FLAMETHROWER );
...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_SHOTGUN_IDLE2 );
	ADD_ACTIVITY_TO_SR( ACT_SHOTGUN_IDLE3 );
