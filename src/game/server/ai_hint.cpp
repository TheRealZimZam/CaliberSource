...
//
// TODOs; Re-implement HINT_TACTICAL_COVER_HIGH and WORLD_HEAT/BLOOD
//=============================================================================//
...
hinttypedescs_t g_pszHintDescriptions[] =
{
	...
	{	HINT_WORLD_BUTTON, "World: Usable button"	},
	{	HINT_WORLD_MACHINERY, "World: Running machinery"	},
	{	HINT_WORLD_LEDGE, "World: Far drop point"	},
	{	HINT_WORLD_LIGHT_SOURCE, "World: Normal light"	},
	{	HINT_WORLD_HEAT_SOURCE, "World: Heat Source"	},
	{	HINT_WORLD_BLINKING_LIGHT, "World: Blinking/damaged light"	},
	//{	HINT_WORLD_BRIGHT_COLORS, "World: Intresting colours"	},
	{	HINT_WORLD_HUMAN_BLOOD, "World: HBlood"	},
	{	HINT_WORLD_ALIEN_BLOOD, "World: ABlood"	},
	...
	{	HINT_TACTICAL_PINCH, "Tactical: Door Pinch"	},
	{	HINT_TACTICAL_GUARD, "Tactical: Guard point"	},
	{	HINT_TACTICAL_ENEMY_DISADVANTAGED, "Tactical: Enemy Disadvantage point"	},
	//{	HINT_NOT_USED_HEALTH_KIT, "Obsolete / Unused"	},
	{	HINT_TACTICAL_COVER_HIGH, "Tactical: Cover"	},
	...
	{	HINT_ASSASSIN_SECLUDED, "Assassin: Secluded spot"	},
	{	HINT_ASSASSIN_RAFTERS, "Assassin: Rafters"	},
	{	HINT_ASSASSIN_GROUND, "Assassin: Open space"	},
	{	HINT_ASSASSIN_MONKEYBARS, "Assassin: Swing spot"	},
