...
//
// Purpose: A poorly-made gun that shoots different types of ammo that does different 
// things, kicks like a bull, and has a good chance of killing the user aswell.
//
//=============================================================================//
...
#define BOLT_AIR_VELOCITY	2400
#define BOLT_WATER_VELOCITY	1200

extern ConVar sk_plr_dmg_scrapgun;
extern ConVar sk_npc_dmg_scrapgun;
...
void CCrossbowBolt::BoltTouch( CBaseEntity *pOther )
{
	...
	if ( pOther->m_takedamage != DAMAGE_NO )
	{
		...
		{
			CTakeDamageInfo	dmgInfo( this, GetOwnerEntity(), sk_plr_dmg_scrapgun.GetFloat(), DMG_NEVERGIB );
		...
		{
			CTakeDamageInfo	dmgInfo( this, GetOwnerEntity(), sk_plr_dmg_scrapgun.GetFloat(), DMG_BULLET | DMG_NEVERGIB );
			CalculateMeleeDamageForce( &dmgInfo, vecNormalizedVel, tr.endpos, 0.7f );
			dmgInfo.SetDamagePosition( tr.endpos );
			pOther->DispatchTraceAttack( dmgInfo, vecNormalizedVel, &tr );
		}
