...
enum Hint_e
{
	...
	HINT_TACTICAL_GUARD,				// Try to guard this area
	HINT_TACTICAL_ENEMY_DISADVANTAGED,	// Disadvantageous position for the enemy
	HINT_HEALTH_KIT,
	HINT_TACTICAL_COVER_HIGH,			// General cover, almost useless
	...
	HINT_JUMP_OVERRIDE,
	HINT_PLAYER_SQUAD_TRANSITON_POINT,
	HINT_NPC_EXIT_POINT,
	HINT_STRIDER_NODE,
