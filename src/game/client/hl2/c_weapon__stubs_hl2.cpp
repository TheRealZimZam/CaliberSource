...
STUB_WEAPON_CLASS( weapon_flameprojector, WeaponFlameprojector, C_BaseHLCombatWeapon );
...
STUB_WEAPON_CLASS( weapon_mitcl, WeaponMITCL, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_lightrpg, WeaponLightRPG, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_pistol, WeaponPistol, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_gpistol, WeaponGPistol, C_BaseHLCombatWeapon );
