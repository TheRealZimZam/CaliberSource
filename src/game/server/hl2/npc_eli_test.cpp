...
// Purpose: 
//-----------------------------------------------------------------------------
class CNPC_Eli_test : public CAI_BaseActor
{
public:
	DECLARE_CLASS( CNPC_Eli_test, CAI_BaseActor );
...
LINK_ENTITY_TO_CLASS( npc_eli_test, CNPC_Eli_test );

//-----------------------------------------------------------------------------
// Classify - indicates this NPC's place in the 
// relationship table.
//-----------------------------------------------------------------------------
Class_T	CNPC_Eli_test::Classify ( void )
{
...
//-----------------------------------------------------------------------------
void CNPC_Eli_test::HandleAnimEvent( animevent_t *pEvent )
{
	switch( pEvent->event )
	{
	case 1:
...
//-----------------------------------------------------------------------------
int CNPC_Eli_test::GetSoundInterests ( void )
{
	return	NULL;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Eli_test::SetupWithoutParent( void )
{
	SetSolid( SOLID_BBOX );
	AddSolidFlags( FSOLID_NOT_STANDABLE );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Eli_test::PrescheduleThink( void )
{
