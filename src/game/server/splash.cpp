...
//
// Purpose: Serverside leak effect
//
// $NoKeywords: $
//=============================================================================
...
#define SPLASH_ENTITYNAME		"env_leak"
...
IMPLEMENT_SERVERCLASS_ST(CSplash, DT_Splash)
	...
	SendPropInt	 (	SENDINFO(m_bSplashSound), 1, SPROP_UNSIGNED),
...
LINK_ENTITY_TO_CLASS(env_leak, CSplash);
...
BEGIN_DATADESC( CSplash )
	...
	DEFINE_KEYFIELD( m_bSplashSound,		FIELD_BOOLEAN,	"splashsound" ),
...
//	DEFINE_OUTPUT(m_OnSplash, "OnSplash"),
...
CSplash* CSplash::CreateSplash(const Vector &vPosition)
{
	...
	if(pEnt)
	{
		...
		if(pSplash)
		{
			...
			pSplash->Activate();
			//m_OnSplash.FireOutput( this, this );
			return pSplash;
		}
		else
		{
