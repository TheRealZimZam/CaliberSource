...
private:
	...
	void DrawAmmoBar( C_BaseCombatWeapon *pWeapon, int x, int y );
				...
				if ( i == iActiveSlot )
				{
					...
					for (int slotpos = 0; slotpos <= iLastPos; slotpos++)
					{
						...
						else
						{
							...
							// Draw Ammo Bar
							DrawAmmoBar( pWeapon, xpos + 10, ypos);
						}
...
//-----------------------------------------------------------------------------
// Purpose: paint the ammo bar
//-----------------------------------------------------------------------------
void CHudWeaponSelection::DrawAmmoBar( C_BaseCombatWeapon *pWeapon, int x, int y )
{
	...
	gHUD.DrawIconProgressBar(x, y, ammoBar, ammoBar, ammoPerc, col, CHud::HUDPB_VERTICAL);
}
