...
LINK_ENTITY_TO_CLASS( monster_barney, CNPC_OldBarney );
...
void CNPC_OldBarney::Spawn()
{
	...
	m_fGunDrawn			= false;
	m_cAmmoLoaded		= BARNEY_CLIP_SIZE;
	...
	SetUse( &CNPC_OldBarney::FollowerUse );
}

//=========================================================
// Precache - precaches all resources this monster needs
//=========================================================
void CNPC_OldBarney::Precache()
{
...
void CNPC_OldBarney::ModifyOrAppendCriteria( AI_CriteriaSet& criteriaSet )
{
...
//=========================================================
int CNPC_OldBarney::GetSoundInterests ( void) 
{
	return	SOUND_WORLD	|
			SOUND_COMBAT	|
			SMELL_CARCASS	|
...
// relationship table.
//=========================================================
Class_T	CNPC_OldBarney::Classify ( void )
{
...
//=========================================================
void CNPC_OldBarney::AlertSound( void )
{
	if ( GetEnemy() != NULL )
	{
		if ( IsOkToSpeak() )
...
//=========================================================
void CNPC_OldBarney::SetYawSpeed ( void )
{
	int ys;
...
// CheckRangeAttack1
//=========================================================
bool CNPC_OldBarney::CheckRangeAttack1 ( float flDot, float flDist )
{
...
// Output  :
//------------------------------------------------------------------------------
int CNPC_OldBarney::RangeAttack1Conditions( float flDot, float flDist )
{
	if (GetEnemy() == NULL)
	{
		return( COND_NONE );
...
//=========================================================
void CNPC_OldBarney::BarneyFirePistol ( void )
{
...
int CNPC_OldBarney::OnTakeDamage_Alive( const CTakeDamageInfo &inputInfo )
{
...
// PainSound
//=========================================================
void CNPC_OldBarney::PainSound( const CTakeDamageInfo &info )
{
...
// DeathSound 
//=========================================================
void CNPC_OldBarney::DeathSound( const CTakeDamageInfo &info )
{
	CPASAttenuationFilter filter( this );
...
void CNPC_OldBarney::TraceAttack( const CTakeDamageInfo &inputInfo, const Vector &vecDir, trace_t *ptr )
{
...
void CNPC_OldBarney::Event_Killed( const CTakeDamageInfo &info )
{
...
void CNPC_OldBarney::SUB_StartLVFadeOut( float delay, bool notSolid )
{
	SetThink( &CNPC_OldBarney::SUB_LVFadeOut );
...
void CNPC_OldBarney::SUB_LVFadeOut( void  )
{
...
void CNPC_OldBarney::StartTask( const Task_t *pTask )
{
	BaseClass::StartTask( pTask );	
}

void CNPC_OldBarney::RunTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
...
//=========================================================
void CNPC_OldBarney::HandleAnimEvent( animevent_t *pEvent )
{
	switch( pEvent->event )
	{
...
int CNPC_OldBarney::TranslateSchedule( int scheduleType )
{
	switch( scheduleType )
	{
...
// of the proper type.
//=========================================================
int CNPC_OldBarney::SelectSchedule( void )
{
...
void CNPC_OldBarney::DeclineFollowing( void )
{
...
bool CNPC_OldBarney::CanBecomeRagdoll( void )
{
	if ( UTIL_IsLowViolence() )
	{
		return false;
...
bool CNPC_OldBarney::ShouldGib( const CTakeDamageInfo &info )
{
	if ( UTIL_IsLowViolence() )
	{
		return false;
...
AI_BEGIN_CUSTOM_NPC( monster_barney, CNPC_OldBarney )
