...
#ifndef AI_BASETALKER_H
#define AI_BASETALKER_H
...
#define TLK_INVESTIGATE						"TLK_INVESTIGATE"
...
public:
	...
	void OnSpokeConcept( CAI_BaseTalker *pPlayerAlly, AIConcept_t concept, AI_Response *response  );
...
class CAI_BaseTalker : public CAI_BaseActor
{
	DECLARE_CLASS( CAI_BaseTalker, CAI_BaseActor );
...
bool CAI_BaseTalker::CanSpeakWhileScripting()
{
