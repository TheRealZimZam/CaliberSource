...
void CWeaponSMG1::AddViewKick( void )
{
	...
	DoMachineGunKick( pPlayer, SMG1_EASY_DAMPEN, SMG1_MAX_VERTICAL_KICK, m_fFireDuration, SMG1_SLIDE_LIMIT );
}
...
//=============================================================================//
// SMG2
// I hate to do a lazy copy like this and would instead like to use smg1 
// as the baseclass, but it really doesnt like that - Solution later, function now
//=============================================================================//
