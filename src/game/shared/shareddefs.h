...
#else
	#define MAX_PLAYERS				33  // Absolute max players supported (32 + gamemanager)
#endif
...
#define TRACER_TYPE_SHOTGUN		0x00000016
...
#define DMG_SLOWFREEZE		(1 << 22)	// in a freezer
...
#define DMG_VEHICLE			(1<<30)		// hit by a physics vehicle, brush vehicles still use crush

#define DMG_REMOVENORAGDOLL	(1<<31)		// with this bit OR'd in, no ragdoll will be created, and the target will be quietly removed.
