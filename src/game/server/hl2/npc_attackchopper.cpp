...
#define CHOPPER_BOMB_DROP_COUNT sk_helicopter_grenade_count.GetInt()
...
ConVar	sk_helicopter_grenade_count( "sk_helicopter_grenade_count","6", 0, "How many bombs the chopper come stocked with." );

// Number of bomb hits it takes to kill a chopper on each skill level.
ConVar sk_helicopter_num_bombs1("sk_helicopter_num_bombs1", "2");
ConVar sk_helicopter_num_bombs2("sk_helicopter_num_bombs2", "3");
ConVar sk_helicopter_num_bombs3("sk_helicopter_num_bombs3", "4");
...
#define BOMBLET_HELICOPTER_MODEL "models/combine_helicopter/helicopter_bomb02.mdl"
...
// Fire rockets
//------------------------------------------------------------------------------
void CNPC_AttackHelicopter::AimRocketGun( void )
{
	//TODO;
#if 0
...
void CNPC_AttackHelicopter::FireRocket( Vector vLaunchPos, Vector vLaunchDir )
{
	//TODO;
#if 0
...
void CGrenadeHelicopter::Precache( void )
{
	...
	PrecacheModel( BOMBLET_HELICOPTER_MODEL );
...
void CGrenadeHelicopter::Spawn( void )
{
	...
	{
		// Cluster bomb
		SetModel( BOMBLET_HELICOPTER_MODEL );
		SetSolid( SOLID_BBOX );
		SetCollisionBounds( Vector( -10.5, -10.5, -10.5 ), Vector( 10.5, 10.5, 10.5 ) );
...
void CGrenadeHelicopter::DoExplosion( const Vector &vecOrigin, const Vector &vecVelocity )
{
	...
	{
		UTIL_ScreenShake( GetAbsOrigin(), GetShakeAmplitude(), 150.0, 1.0, (sk_helicopter_grenaderadius.GetFloat() * 2), SHAKE_START );
	}
