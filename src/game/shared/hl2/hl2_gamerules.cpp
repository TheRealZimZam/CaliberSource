...
//		def.AddAmmoType("AR2Sniper",		DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_ar2_sniper",	"sk_npc_dmg_ar2",			"sk_max_ar2",			BULLET_IMPULSE(200, 1225), 0 );
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("ScrapGun",				DMG_BULLET,				TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_scrapgun",		"sk_npc_dmg_scrapgun",		"sk_max_scrapgun",		BULLET_IMPULSE(800, 5000), 0 ); // Ammo picked up is the same
...
//		def.AddAmmoType("Brickbat",				DMG_CLUB,				TRACER_NONE, 			"sk_plr_dmg_brickbat",		"sk_npc_dmg_brickbat",		"sk_max_brickbat",		0);
		...
		//
		//=====================================================================
		// Cool. Mind if I change this to 10?
#ifdef HL2_EPISODIC
		def.AddAmmoType("StriderMinigun",	DMG_BULLET,					TRACER_LINE,			5, 10, 15, 1.0 * 750 * 12, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 1.0kg weight at 750 ft/s
#else
...
//		def.AddAmmoType("Grenade",				DMG_BURN,				TRACER_NONE,			"sk_plr_dmg_grenade",		"sk_npc_dmg_grenade",		"sk_max_grenade",		0, 0);
//		def.AddAmmoType("StunGrenade",			DMG_BURN,				TRACER_NONE,			NULL,		NULL,		"sk_max_stun_grenade",		0, 0);
